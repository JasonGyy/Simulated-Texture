function vpsc_Activity = vpsc_Activity(~)
%% For FCC
...
% ************************************************************************
activity1 = dlmread('ACT_PH1.OUT','',1,0);
activity2 = dlmread('ACT_PH2.OUT','',1,0);
% STAT_AX.OUT  - statistics on grain axes 
% STAT.OUT GENERAL INFORMATION AT SELECTED STEPS
% epsacu = Statistics for deformation
% stat_ax= 'STAT_AX.OUT';
% stress_strain_data = readmatrix('STR_STR.OUT','FileType','text', 'Delimiter','\t');
stress_strain_data = dlmread('STR_STR.OUT','',1,0)
...
% &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
saveas(gcf,'Stress_Strain_plot.svg')
%% Plotting AVACS
